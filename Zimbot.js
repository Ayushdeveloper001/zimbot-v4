...
const reply = (teks) => {
  ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ᴢɪᴍ ʙᴏᴛ ᴠ5",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "AYUSH OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://www.youtube.com/@ayushmuzik1037")}}})
}
const replay = (teks) => {
  ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ᴢɪᴍ ʙᴏᴛ ᴠ5",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "AYUSH OFC", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://www.youtube.com/@ayushmuzik1037")}}})
}    
...
hydratedContentText: text,
hydratedFooterText: `⦿ɢɪᴛʜᴜʙ: https://www.youtube.com/@ayushmuzik1037 \n®ᴢɪᴍʙᴏᴛɪɴᴄ 2023`,
hydratedButtons: content,
},
},
},
...
body: "GIVE IT A STAR",
mediaType: "VIDEO",
mediaUrl: `https://githb.com/ayushdeveloper001/zimbot-v4`,
description: 'AYUSH OFC',
previewType: "PHOTO",
...
hydratedButtons:  [{        
    "urlButton": {
      ...
      "url": "https://www.youtube.com/@ayushmuzik1037"
    }
}, {
quickReplyButton: {
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*ᴢɪᴍ ʙᴏᴛ ɪɴᴄ ANNOUNCEMENT:* *SUBSCRIBE TO AYUSH OFC*\n\n*YOUTUBE:* https://www.youtube.com/@ayushmuzik1037\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing zim-bot*`,contextInfo: { externalAdReply:{title:"ᴢɪᴍ ʙᴏᴛ ᴠ5",body:"SUBSCRIBE AYUSH OFC",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(`./drips.jpg`) ,mediaUrl:`https://www.youtube.com/@ayushmuzik1037`, sourceUrl: `https://www.youtube.com/@ayushmuzik1037` }}}, {quoted: m})
...
*/
  ...
  /*  case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
   ZimBotInc.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/TfI3QYW.jpg' }, caption: `*𝗛𝗜 𝗕𝗥𝗢 ${m.pushName}*\n\n Per Private Bot Price is 350 rs Gr via Gpay/paytm/phonepe 1.5 Month\n\nFor more details, you can chat with the owner\nhttps://wa.me/918602306506 (ZIM BOT OWNER)\n\n𝗗𝗢𝗡𝗔𝗧𝗘 : \n\n 𝗙𝗔𝗠𝗣𝗔𝗬 : wa.me/918602306506` }, { quoted: m })
 }
 */
 break
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *ZIM-BOT-V4*\n\n*YOUTUBE:* https://youtube.com/@ayushmuzik1037:* https://youtube.com/@ayushmuzik1037\n\n*DONATE:* wa.me/918602306506`
  let buttons = [
  ...
  sourceUrl: "https://www.youtube.com/@ayushmuzik1037g"
  }}
  }
...
reply(mess.wait)
 ...
 if(!args[0]) throw 'link github  EXAMPLE: https://www.youtube.com/@ayushmuzik1037/zim-bot-md'
if (!regex1.test(args[0])) throw 'link!'
   let [, user, repo] = args[0].match(regex1) || []
    ...
    ZimBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' , quoted: m,contextInfo: { externalAdReply:{
      ...
      thumbnail: fs.readFileSync('./drips.jpg'),
      mediaUrl:`https://www.youtube.com/@ayushmuzik1037`, 
      sourceUrl: `https://www.youtube.com/@ayushmuzik1037`,
      }}
      })
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(`./drips.jpg`) ,
        mediaUrl:`https://www.youtube.com/@ayushmuzik1037`, 
        sourceUrl: `https://www.youtube.com/@ayushmuzik1037` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'githubsearch': 
       case 'searchgithub':
...
for (let yoi of anu) {
 ...
 urlButton: {
  displayText: 'GITHUB',
  url: 'https://www.youtube.com/@ayushmuzik1037/zimbot-v2'
 }
  }, {
 quickReplyButton: {
  displayText: 'OWNER',
...
let buttonMessage = {
        ...
        jpegThumbnail:buf,
        caption: caption,
        footer: ` ⦿ɢɪᴛʜᴜʙ: https://www.youtube.com/@ayushmuzik1037 \n®ᴢɪᴍʙᴏᴛɪɴᴄ 2023`,
        buttons: muziq,
        headerType: 4,
        contextInfo: { externalAdReply:{
        title:"ZIM BOT♡",
...
mediaType:2,
thumbnail: fs.readFileSync(`./drips.jpg`) ,
mediaUrl:`https://wa.me/918602305405`, 
sourceUrl: `https://www.youtube.com/@ayushmuzik1037` }
},
}, {quoted: m})
...
thumbnail: fs.readFileSync(`./drips.jpg`) ,
mediaUrl:`https://wa.me/918602305405`, 
sourceUrl: `https://wa.me/918602305405` }
},
}, {quoted: m})
...
%readmore` 
    var buttonReplyy = [
				{ urlButton: { displayText: `INSTA🍎`, url: `https://www.youtube.com/@ayushmuzik1037` } },
				{ urlButton: { displayText: `SOURCECODE🍏`, url: `https://www.instagram.com/itzisaac_god/` } },
...
let message = await prepareWAMessageMedia({ image: buffer, jpegThumbnail:buffer }, { upload: ZimBotInc.waUploadToServer })
 ...
 var buttonReplyy = [
				{ urlButton: { displayText: `OWNER🍏`, url : `https://wa.me/918602306506` } },
				{ urlButton: { displayText: `SOURCECODE🥦`, url: `https://youtube.com/@ayushmuzik1037` } },
				{ urlButton: { displayText: `SUPPORT🍎`, url: `http://` } }
			]
...
let message = await prepareWAMessageMedia({ image: buffer, jpegThumbnail:buffer }, { upload: ZimBotInc.waUploadToServer })
 var buttonReplyy = [
  urlButton: { displayText: `OWNER🍏`, url : `https://wa.me/4474` } },
  { urlButton: { displayText: `SOURCECODE🥦`, url: `https://www.youtube.com/@ayushmuzik1037` } },
  { urlButton: { displayText: `INSTA🍎`, url: `https://www.instagram.com/itzisaac_god/` } }
]
			]
...
└───〔 *_ᴢɪᴍ ʙᴏᴛ ɪɴᴄ_* 〕
  ...
  let message = await prepareWAMessageMedia({ image: buffer, jpegThumbnail:buffer }, { upload: ZimBotInc.waUploadToServer })
  var buttonReplyy = [
				{ urlButton: { displayText: `OWNER🍏`, url : `https://wa.me/918602305405` } },
				{ urlButton: { displayText: `SOURCECODE🥦`, url: `https://www.youtube.com/@ayushmuzik1037` } },
				{ urlButton: { displayText: `INSTA🍎`, url: `https://www.instagram.com/itzisaac_god/` } }
			]
